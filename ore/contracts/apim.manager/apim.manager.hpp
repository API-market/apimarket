...
#include "../../../../ore-protocol/contracts/ore.instrument/ore.instrument.hpp"

using namespace eosio;
using namespace std;

class [[eosio::contract("apiregistry")]] apiregistry : public eosio::contract
{
  public:
    apiregistry(name receiver, name code, datastream<const char*> ds) : contract(receiver, code, ds),  _offers_data(receiver, receiver.value) {}
    ...
    typedef eosio::multi_index<"offersdata"_n, offer_data> _offersdata;

    _offersdata _offers_data;
    ...
    void publishapi(name creator, name issuer, string api_voucher_license_price_in_cpu, string api_voucher_lifetime_in_seconds,
    ...
    void licenseapi(name creator, name buyer, uint64_t offer_id, string offer_template, vector<ore_types::api_voucher_params> api_voucher_additional_url_params, string voucher_encrypted_by = "", uint64_t override_voucher_id = 0);
};
