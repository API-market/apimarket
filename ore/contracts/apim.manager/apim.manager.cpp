...
name INSTRUMENT_CONTRACT_NAME = "instr.ore"_n;
name RIGHTS_CONTRACT_NAME = "rights.ore"_n;
name TOKEN_CONTRACT_NAME = "token.ore"_n;
...
void apiregistry::publishapi(name creator, name issuer, string api_voucher_license_price_in_cpu, string api_voucher_lifetime_in_seconds,
                             ...
                             uint64_t offer_end_time, uint64_t offer_override_id)
{
    ...
    if (instr_contract.isToken(offer_override_id))
    {
        ...
        mint_instrument.actions.emplace_back(
            eosio::permission_level{creator, "active"_n}, INSTRUMENT_CONTRACT_NAME, "update"_n,
...
void apiregistry::licenseapi(name creator, name buyer, uint64_t offer_id, string offer_template, vector<ore_types::api_voucher_params> api_voucher_additional_url_params, string voucher_encrypted_by, uint64_t override_voucher_id)
{
...
EOSIO_DISPATCH(apiregistry, (publishapi)(licenseapi))